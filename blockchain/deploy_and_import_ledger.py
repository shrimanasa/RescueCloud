"""
deploy_and_import_ledger.py
============================
Deploys BackupLedger smart contract. Optionally imports a prior ledger export.
Usage: python3 blockchain/deploy_and_import_ledger.py [--import file.json]
Writes deployed contract address to .env as BACKUP_LEDGER_ADDRESS.
"""
...
#   1. Start the Hardhat local node: npx hardhat node
#   2. Compile contracts: npx hardhat compile
#   3. Run this script: python3 blockchain/deploy_and_import_ledger.py
#   4. Verify BACKUP_LEDGER_ADDRESS is written to .env
#   5. Test registration: python3 blockchain/register_backup.py
# In production, replace Hardhat with a real EVM network (e.g. Polygon PoS).
