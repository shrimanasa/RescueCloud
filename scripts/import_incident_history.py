"""
import_incident_history.py
==========================
Imports JSON/CSV incident history into security_incidents table.
Validates required fields, ISO 8601 timestamps, non-negative floats.
Skips duplicate run_id values (idempotent).
"""
