...
=====================
Runs N recovery trials WITHOUT anomaly detection as the unprotected baseline.
Results -> results/baseline_batch.csv (restore_only_seconds, clean_recovery).
"""
...
# ---------------------------------------------------------------------------
# After running this script, compare with research_metrics.csv:
#   python3 -c "
#   import pandas as pd
#   baseline = pd.read_csv('results/baseline_batch.csv')
#   treatment = pd.read_csv('results/research_metrics.csv')
#   print('Baseline RTO:', baseline['restore_only_seconds'].mean())
#   print('Treatment RTO:', treatment['rto_seconds'].mean())
#   "
